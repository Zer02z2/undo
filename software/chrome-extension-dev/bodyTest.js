    ...
    return E(function (p) {
      switch (p.h) {
        ...
        case 2:
          ...
          if ("object" === typeof window)
            return (
              bd("createMediapipeSolutionsWasm", { locateFile: a.locateFile }),
  ...
  function id(a, b) {
    ...
    g = a.i.PacketListener.implement({
      onResults: function (h) {
        ...
        var m = a.listeners[c]
        m &&
          (a.I = kd(a, k, b.outs).then(function (r) {
            r = m(r)
    ...
    this.h = new ed({
      ...
      files: function (c) {
        return [
          ...
          { data: !0, url: md(c.modelSelection) },
        ]
      },
            ...
            return E(function (f) {
              if (1 == f.h)
                return (
                  (d = md(c)),
                  (e =
                    "third_party/mediapipe/modules/selfie_segmentation/" + d),
                  D(f, gd(b.h, d), 2)
                )
              g = f.i
